  ...
  void initState() {
    ...
    itemRef.once().then((DataSnapshot value) {
      ...
      for(int i=0; i<value.value.length; i++) {
        newsData.add(new NewsItem.fromJSON(value.value[i]));
      }
...
//      tempWidgets.add(_buildCard(1 - startOffset, cardsVisible, scrollPercent, activeCardIndex-1));
    ...
    tempWidgets.add(_buildCard(2, cardsVisible, scrollPercent, 2));
    tempWidgets.add(_buildCard(1, cardsVisible, scrollPercent, 1));
    tempWidgets.add(_buildCard(0, cardsVisible, scrollPercent, 0));
